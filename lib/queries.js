...
async function viewEmployeesAllData() {
    const SQL_STATEMENT = `SELECT employee.id, first_name, last_name, title, salary, department.name FROM employee
...
module.exports = {
    viewEmployees, viewRoles, addEmployee, viewDepartments, addRole, addDept, updateRole, viewEmployeesAllData
};